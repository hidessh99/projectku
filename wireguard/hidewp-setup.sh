...
# Tambahan
cd /usr/bin
wget -O add-wg "https://raw.githubusercontent.com/kmardhex/rev/main/xcore/add-wg.sh"
wget -O del-wg "https://raw.githubusercontent.com/kmardhex/rev/main/xcore/del-wg.sh"
wget -O cek-wg "https://raw.githubusercontent.com/kmardhex/rev/main/xcore/cek-wg.sh"
wget -O renew-wg "https://raw.githubusercontent.com/kmardhex/rev/main/xcore/renew-wg.sh"
chmod +x add-wg
chmod +x del-wg
chmod +x cek-wg
chmod +x renew-wg
